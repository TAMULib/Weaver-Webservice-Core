...
public class EntityUtility {
    ...
    public static List<Object> queryById(Object model, Long id) {
        return queryWithClassById(model.getClass(), id);
    }

    public static List<Object> queryWithClassById(Class<?> clazz, Long id) {
    ...
    public static List<Object> queryAllWithClass(Class<?> clazz) {
        EntityManager entityManager = SpringContext.bean(EntityManager.class);
        CriteriaBuilder cb = entityManager.getCriteriaBuilder();
        CriteriaQuery<Object> query = cb.createQuery();
        Root<?> root = query.from(clazz);
    ...
    public static List<Object> queryByPosition(Class<?> clazz, Long position) {
        EntityManager entityManager = SpringContext.bean(EntityManager.class);
        CriteriaBuilder cb = entityManager.getCriteriaBuilder();
        CriteriaQuery<Object> query = cb.createQuery();
        Root<?> root = query.from(clazz);
    ...
    public static List<Object> queryByProperty(Class<?> clazz, String property, Object value) {
        EntityManager entityManager = SpringContext.bean(EntityManager.class);
        CriteriaBuilder cb = entityManager.getCriteriaBuilder();
        CriteriaQuery<Object> query = cb.createQuery();
        Root<?> root = query.from(clazz);
