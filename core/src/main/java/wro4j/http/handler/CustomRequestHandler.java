...
public class CustomRequestHandler extends ReloadCacheRequestHandler {
	...
	//ReloadCacheRequestHandler is only enabled in debug mode by default. We need it in prod to reload the cache dynamically after theme updates
	//TODO consider ways of restricting access to the reload endpoint to prevent rogue refreshes of the cache
	@Override
